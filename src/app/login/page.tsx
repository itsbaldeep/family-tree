...
export default function LoginPage() {
    ...
    return (
        <main className="min-h-screen flex items-center justify-center p-6">
            <div className="max-w-md w-full rounded-2xl shadow p-8 border">
                <h1 className="text-2xl font-semibold mb-6">Sign in</h1>
                <button
                    onClick={handleLogin}
                    className="w-full rounded-xl border px-4 py-3 hover:bg-gray-50 active:scale-[.99] transition flex items-center gap-2"
                >
                    <GoogleLogo />
...
const GoogleLogo = () => {
    return (
        <svg xmlns="https://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 40 48" aria-hidden="true">
